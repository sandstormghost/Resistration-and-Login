...
def login():
    ...
    Label(login_screen, text="").pack()
    Button(login_screen, text="Login", width=10, height=1, command = login_verify, bg="lightblue").pack()
 
# Implementing register button
...
def login_verify():
    ...
    if username1 in list_of_files:
        ...
        if password1 in verify:
            login_sucess()
            print('User ID :',verify[0])
            print('Password:',verify[1])
        else:
